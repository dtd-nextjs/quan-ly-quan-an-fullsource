...
import { useAccountListQuery, useDeleteEmployeeMutation } from '@/queries/useAccount'
  ...
  return (
    <AccountTableContext.Provider value={{ employeeIdEdit, setEmployeeIdEdit, employeeDelete, setEmployeeDelete }}>
      <div className='w-full'>
        <EditEmployee id={employeeIdEdit} setId={setEmployeeIdEdit} onSubmitSuccess={accountListQuery.refetch} />
