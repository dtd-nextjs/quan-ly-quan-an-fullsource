...
import { useDishListQuery, useDeleteDishMutation } from '@/queries/useDish'
...
export default function DishTable() {
  ...
  const dishtListQuery = useDishListQuery()
  const data = dishtListQuery.data?.payload.data ?? []
  ...
  return (
    <DishTableContext.Provider value={{ dishIdEdit, setDishIdEdit, dishDelete, setDishDelete }}>
      <div className='w-full'>
        <EditDish id={dishIdEdit} setId={setDishIdEdit} onSubmitSuccess={dishtListQuery.refetch} />
