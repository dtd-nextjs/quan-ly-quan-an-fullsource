...
import { useTableListQuery, useDeleteTableMutation } from '@/queries/useTable'
...
export default function TableTable() {
  ...
  const tabletListQuery = useTableListQuery()
  const data = tabletListQuery.data?.payload.data ?? []
